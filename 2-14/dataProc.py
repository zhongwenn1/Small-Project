...
class DataProc:
	...
	def processLines(self):
		...
		self.slipping = self.range151To200(self.dfinal)    # choose the range 151 to 200 from beam_diff (bags might slipping on belt..etc.)

		self.pushed = self.rangeM1ToM50(self.dfinal)      # choose the range -1 to -50 from beam_diff (bags might pushed by operator..etc.)

		# elapsed = timeit.default_timer() - start_time
		# print("time cost df:", elapsed)
